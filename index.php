...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/img-22.jpg');">
			<div class="wrap-login100 p-t-190 p-b-30">
				<form action="login.php" method="post" class="login100-form">
					...
					<span class="login100-form-title p-t-20 p-b-45">
						E-Parking <div id="hasil"></div>
					</span>

					<div class="wrap-input100 validate-input m-b-10" data-validate = "NIK is required">
						<input class="input100" type="text" name="email" id="email" placeholder="Email" required="required">
					...
					<div class="container-login100-form-btn p-t-10">
                        ...
                        <a href="#" style="color: white;">
							Registration if you don't have account
						</a>
					</div>
				</form>
			</div>
